...
internal: $@ ## Generate Pbs and build for greet
...
clean: clean_internal clean_calculator clean_blog ## Clean generated files
	${RM_F_CMD} ssl/*.crt
	${RM_F_CMD} ssl/*.csr
	${RM_F_CMD} ssl/*.key
	${RM_F_CMD} ssl/*.pem
...
clean_internal: ## Clean generated files for greet
	${RM_F_CMD} internal/${PROTO_DIR}/*.pb.go
